...
func (c *mediaServiceClient) SavePhoto(ctx context.Context, in *SavePhotoRequest, opts ...grpc.CallOption) (*SavePhotoResponse, error) {
	cOpts := append([]grpc.CallOption{grpc.StaticMethod()}, opts...)
	out := new(SavePhotoResponse)
	err := c.cc.Invoke(ctx, MediaService_SavePhoto_FullMethodName, in, out, cOpts...)
	if err != nil {
		return nil, err
	}
	return out, nil
...
func _MediaService_SavePhoto_Handler(srv interface{}, ctx context.Context, dec func(interface{}) error, interceptor grpc.UnaryServerInterceptor) (interface{}, error) {
	in := new(SavePhotoRequest)
	if err := dec(in); err != nil {
		return nil, err
	}
	if interceptor == nil {
		return srv.(MediaServiceServer).SavePhoto(ctx, in)
	}
	info := &grpc.UnaryServerInfo{
		Server:     srv,
		FullMethod: MediaService_SavePhoto_FullMethodName,
	}
	handler := func(ctx context.Context, req interface{}) (interface{}, error) {
		return srv.(MediaServiceServer).SavePhoto(ctx, req.(*SavePhotoRequest))
	}
...
var MediaService_ServiceDesc = grpc.ServiceDesc{
	ServiceName: "gomessage.com.media_service.MediaService",
